...
const SKILL_POOL = [
  { id: "sk_gambeta_corta", name: "Gambeta Corta", desc: "Amague rápido que deja rivales atrás.", power: 18, cost: 1, acc: 92, dmg: "regate", tags: ["regate"] },
  { id: "sk_centro_venenoso", name: "Centro Venenoso", desc: "Centro rasante al área que genera peligro.", power: 19, cost: 2, acc: 90, dmg: "pase", tags: ["pase"] },
  { id: "sk_pase_filtrado", name: "Pase Filtrado", desc: "Pase entre líneas que rompe la defensa.", power: 17, cost: 2, acc: 88, dmg: "pase", tags: ["pase", "creativo"] },
  { id: "sk_enganchar", name: "Enganchar y Patear", desc: "Recorte y remate al arco.", power: 20, cost: 2, acc: 85, dmg: "tiro", tags: ["tiro", "regate"] },
  { id: "sk_definicion_letal", name: "Definición Letal", desc: "Remate inapelable al primer toque.", power: 21, cost: 2, acc: 92, dmg: "tiro", tags: ["tiro"] },
  { id: "sk_depredador", name: "Depredador del Área", desc: "Se anticipa y mete el gol imposible.", power: 24, cost: 4, acc: 85, dmg: "tiro", tags: ["tiro", "élite"], cd: 3 },
  { id: "sk_tiki_taka", name: "Tiki-Taka", desc: "Pase al primer toque que desorganiza.", power: 17, cost: 1, acc: 95, dmg: "pase", tags: ["pase"] },
  { id: "sk_pressing", name: "Presión Alta", desc: "Persigue sin descanso y recupera.", power: 18, cost: 2, acc: 92, dmg: "defensa", tags: ["defensa"] },
  { id: "sk_barrida", name: "Barrida Precisa", desc: "Entrada por abajo, limpia la jugada.", power: 18, cost: 1, acc: 90, dmg: "defensa", tags: ["defensa"] },
  { id: "sk_cabezazo", name: "Cabezazo", desc: "Remate de cabeza imponente.", power: 19, cost: 1, acc: 88, dmg: "fisico", tags: ["aéreo"] },
  { id: "sk_chilena", name: "Chilena", desc: "Remate acrobático de espaldas al arco.", power: 21, cost: 3, acc: 70, dmg: "tiro", tags: ["tiro", "acrobacia"], cd: 2 },
  { id: "sk_bombazo", name: "Bombazo", desc: "Disparo potente de larga distancia.", power: 22, cost: 3, acc: 78, dmg: "tiro", tags: ["tiro"], cd: 2 },
  { id: "sk_sombrero", name: "Sombrero", desc: "Pasa la pelota por arriba del rival.", power: 17, cost: 1, acc: 90, dmg: "regate", tags: ["regate"] },
  { id: "sk_caño", name: "Caño", desc: "Pase entre las piernas del rival.", power: 15, cost: 1, acc: 90, dmg: "regate", tags: ["regate"] },
  { id: "sk_achique", name: "Achique Suicida", desc: "Sale del arco a cortar el mano a mano.", power: 20, cost: 3, acc: 80, dmg: "defensa", tags: ["arco"], cd: 3 },
  { id: "sk_atajada", name: "Atajada Imposible", desc: "Volada espectacular y contraataque letal.", power: 19, cost: 3, acc: 80, dmg: "reflejos", tags: ["arco"], cd: 3 },
  { id: "sk_proyeccion", name: "Proyección Ofensiva", desc: "Pique por la banda y centro preciso.", power: 17, cost: 2, acc: 90, dmg: "pase", tags: ["carrilero"] },
  { id: "sk_marca_personal", name: "Marca Personal", desc: "Sigue al rival como sombra.", power: 18, cost: 2, acc: 95, dmg: "defensa", tags: ["defensa"], cd: 2 },
  { id: "sk_liderazgo", name: "Liderazgo", desc: "Arenga que inspira y golpea la moral rival.", power: 17, cost: 2, acc: 95, dmg: "fisico", tags: ["capitán"], cd: 2 },
  { id: "sk_tiro_libre", name: "Tiro Libre", desc: "Disparo con efecto sobre la barrera.", power: 22, cost: 3, acc: 75, dmg: "tiro", tags: ["tiro"], cd: 3 },
  { id: "sk_quite", name: "Quite Limpio", desc: "Barrida precisa que recupera.", power: 17, cost: 1, acc: 92, dmg: "defensa", tags: ["defensa"] },
  { id: "sk_pared", name: "Pared", desc: "Pase y devolución rápida.", power: 18, cost: 2, acc: 93, dmg: "pase", tags: ["pase"] },
  { id: "sk_media_vuelta", name: "Media Vuelta", desc: "Giro y remate fulminante.", power: 21, cost: 2, acc: 85, dmg: "tiro", tags: ["tiro"], cd: 1 },
  { id: "sk_rabona", name: "Rabona", desc: "Centro o tiro cruzando piernas.", power: 20, cost: 2, acc: 75, dmg: "regate", tags: ["lujo"], cd: 2 },
  { id: "sk_tackleo", name: "Tackleo Firme", desc: "Entrada fuerte que frena al rival.", power: 18, cost: 1, acc: 92, dmg: "fisico", tags: ["fisico"] },
  { id: "sk_zurdazo", name: "Zurdazo al Ángulo", desc: "Disparo colocado al segundo palo.", power: 22, cost: 3, acc: 82, dmg: "tiro", tags: ["tiro"], cd: 2 },
  { id: "sk_diagonal", name: "Diagonal Letal", desc: "Pase largo diagonal que parte la defensa.", power: 18, cost: 2, acc: 90, dmg: "pase", tags: ["pase"], cd: 1 },
  { id: "sk_penales", name: "Especialista en Penales", desc: "Lee al pateador y adivina el palo.", power: 21, cost: 4, acc: 70, dmg: "reflejos", tags: ["arco"], cd: 5 },
  { id: "sk_regate_doble", name: "Regate Doble", desc: "Dos amagos consecutivos.", power: 19, cost: 2, acc: 88, dmg: "regate", tags: ["regate"], cd: 1 },
  { id: "sk_volea", name: "Volea", desc: "Remate de volea cruzada.", power: 22, cost: 3, acc: 72, dmg: "tiro", tags: ["tiro"], cd: 2 },
];
...
const LEGENDARY_PLAYERS: PlayerDef[] = [
  ...
  { id: "p_virgil", name: "Virgil van Dijk", desc: "Centre-Back - Liverpool (Países Bajos)", category: "defensor", rarity: "legendary", types: ["defensa", "aéreo"], tags: ["liverpool", "holandés"], level: 10, statProfile: "def", skillIds: ["sk_cabezazo", "sk_tackleo", "sk_pressing"], passive: "Imposible Pasarlo: -20% regate enemigo", flavor: "Nadie lo supera en el uno contra uno." },
...
const EPIC_PLAYERS: PlayerDef[] = [
  ...
  { id: "p_pezzella", name: "Germán Pezzella", desc: "CB - River Plate (Argentina)", category: "defensor", rarity: "epic", types: ["defensa", "aéreo"], tags: ["river_plate", "argentino"], level: 7, statProfile: "def", skillIds: ["sk_cabezazo", "sk_barrida"], passive: "Muralla: +8% defensa para todo el equipo", flavor: "El Caudillo de Núñez." },
  ...
  { id: "p_martinez_lisandro", name: "Lisandro Martínez", desc: "CB - Manchester United (Argentina)", category: "defensor", rarity: "epic", types: ["defensa", "marca"], tags: ["man_utd", "argentino"], level: 7, statProfile: "def", skillIds: ["sk_barrida", "sk_tackleo"], passive: "Carnicero: -15% fisico enemigo", flavor: "El Butcher de Ajax y Old Trafford." },
  ...
  { id: "p_ruben_dias", name: "Rúben Dias", desc: "CB - Manchester City (Portugal)", category: "defensor", rarity: "epic", types: ["defensa", "aéreo"], tags: ["man_city", "portugués"], level: 8, statProfile: "def", skillIds: ["sk_cabezazo", "sk_pressing"], passive: "Líder Nato: Equipo gana +5 moral por combate", flavor: "El defensor que ganó la Premier." },
...
const ENEMIES: EnemyDef[] = [
  ...
  { id: "e_clasico_rival", name: "Clásico Rival", desc: "El capitán del equipo más odiado.", category: "mediocampista", rarity: "epic", types: ["enganche", "capitán"], tags: ["boss", "primera"], level: 12, statProfile: "mid", skillIds: ["sk_pase_filtrado", "sk_bombazo", "sk_tiro_libre"], flavor: "Superclásico. No hay más que decir.", isBoss: true },
  // Copa 4 - Sudamericana
  ...
  { id: "e_boss_campeon", name: "Campeón Vigente", desc: "El último campeón de la Libertadores.", category: "delantero", rarity: "epic", types: ["goleador", "enganche"], tags: ["boss", "libertadores"], level: 16, statProfile: "att", skillIds: ["sk_definicion_letal", "sk_depredador", "sk_chilena", "sk_media_vuelta"], flavor: "Defender el título o morir en el intento.", isBoss: true },
  ...
  { id: "e_boss_sevilla", name: "Rey de la Europa League", desc: "Especialista en ganar Europa League.", category: "mediocampista", rarity: "epic", types: ["enganche", "capitán"], tags: ["boss", "europa_league"], level: 17, statProfile: "mid", skillIds: ["sk_pase_filtrado", "sk_tiki_taka", "sk_bombazo", "sk_tiro_libre"], flavor: "6 veces campeón.", isBoss: true },
  ...
  { id: "e_boss_real_madrid", name: "Real Madrid CF", desc: "El rey de la Champions League.", category: "delantero", rarity: "legendary", types: ["goleador", "enganche"], tags: ["boss", "champions"], level: 20, statProfile: "att", skillIds: ["sk_definicion_letal", "sk_depredador", "sk_volea", "sk_media_vuelta"], flavor: "La undécima, la duodécima, la que sigue.", isBoss: true },
  ...
  { id: "e_boss_final_mundial", name: "Selección Campeona", desc: "Argentina, Francia o Brasil. La final del mundo.", category: "delantero", rarity: "legendary", types: ["goleador", "enganche", "velocidad"], tags: ["boss", "mundial"], level: 25, statProfile: "att", skillIds: ["sk_definicion_letal", "sk_depredador", "sk_volea", "sk_tiro_libre", "sk_media_vuelta"], flavor: "La final que define tu leyenda.", isBoss: true },
];
...
const SPECIAL_LEGEND_PLAYERS: PlayerDef[] = [
  ...
  { id: "sp_di_stefano", name: "Alfredo Di Stéfano", desc: "Delantero - Leyenda (Argentina)", category: "delantero", rarity: "legendary", types: ["goleador", "creativo"], tags: ["leyenda", "argentino"], level: 14, statProfile: "att", skillIds: ["sk_definicion_letal", "sk_pase_filtrado", "sk_media_vuelta"], passive: "La Saeta Rubia: +20% todo en copas europeas", flavor: "El dueño del Bernabéu." },
  ...
  { id: "sp_beckenbauer", name: "Franz Beckenbauer", desc: "Defensor - Leyenda (Alemania)", category: "defensor", rarity: "legendary", types: ["defensa", "creativo"], tags: ["leyenda", "alemán"], level: 14, statProfile: "def", skillIds: ["sk_diagonal", "sk_bombazo", "sk_tackleo"], passive: "Der Kaiser: +20% defensa equipo, puede atacar como mid", flavor: "Inventó la posición de líbero." },
  { id: "sp_maldini", name: "Paolo Maldini", desc: "Defensor - Leyenda (Italia)", category: "defensor", rarity: "legendary", types: ["defensa", "marca"], tags: ["leyenda", "italiano"], level: 14, statProfile: "def", skillIds: ["sk_marca_personal", "sk_tackleo", "sk_barrida"], passive: "Eterno: -30% daño recibido, inmune a regates", flavor: "Si necesitó hacer un tackle, ya llegó tarde." },
];

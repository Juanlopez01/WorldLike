...
const SKILL_POOL = [
  { id: "sk_gambeta_corta", name: "Gambeta Corta", desc: "Amague rápido que deja rivales atrás.", power: 14, cost: 1, acc: 92, dmg: "regate", tags: ["regate"] },
  { id: "sk_centro_venenoso", name: "Centro Venenoso", desc: "Centro rasante al área que genera peligro.", power: 17, cost: 2, acc: 90, dmg: "pase", tags: ["pase"] },
  { id: "sk_pase_filtrado", name: "Pase Filtrado", desc: "Pase entre líneas que rompe la defensa.", power: 10, cost: 2, acc: 88, dmg: "pase", tags: ["pase", "creativo"] },
  { id: "sk_enganchar", name: "Enganchar y Patear", desc: "Recorte y remate al arco.", power: 19, cost: 2, acc: 85, dmg: "tiro", tags: ["tiro", "regate"] },
  { id: "sk_definicion_letal", name: "Definición Letal", desc: "Remate inapelable al primer toque.", power: 28, cost: 2, acc: 92, dmg: "tiro", tags: ["tiro"] },
  { id: "sk_depredador", name: "Depredador del Área", desc: "Se anticipa y mete el gol imposible.", power: 35, cost: 4, acc: 85, dmg: "tiro", tags: ["tiro", "élite"], cd: 3 },
  { id: "sk_tiki_taka", name: "Tiki-Taka", desc: "Pase al primer toque que desorganiza.", power: 12, cost: 1, acc: 95, dmg: "pase", tags: ["pase"] },
  { id: "sk_pressing", name: "Presión Alta", desc: "Persigue sin descanso y recupera.", power: 14, cost: 2, acc: 92, dmg: "defensa", tags: ["defensa"] },
  { id: "sk_barrida", name: "Barrida Precisa", desc: "Entrada por abajo, limpia la jugada.", power: 15, cost: 1, acc: 90, dmg: "defensa", tags: ["defensa"] },
  { id: "sk_cabezazo", name: "Cabezazo", desc: "Remate de cabeza imponente.", power: 17, cost: 1, acc: 88, dmg: "fisico", tags: ["aéreo"] },
  { id: "sk_chilena", name: "Chilena", desc: "Remate acrobático de espaldas al arco.", power: 22, cost: 3, acc: 70, dmg: "tiro", tags: ["tiro", "acrobacia"], cd: 2 },
  { id: "sk_bombazo", name: "Bombazo", desc: "Disparo potente de larga distancia.", power: 24, cost: 3, acc: 78, dmg: "tiro", tags: ["tiro"], cd: 2 },
  { id: "sk_sombrero", name: "Sombrero", desc: "Pasa la pelota por arriba del rival.", power: 12, cost: 1, acc: 90, dmg: "regate", tags: ["regate"] },
  { id: "sk_caño", name: "Caño", desc: "Pase entre las piernas del rival.", power: 10, cost: 1, acc: 90, dmg: "regate", tags: ["regate"] },
  ...
  { id: "sk_atajada", name: "Atajada Imposible", desc: "Volada espectacular que salva.", power: 0, cost: 4, acc: 75, dmg: "reflejos", tags: ["arco"], cd: 4 },
  { id: "sk_proyeccion", name: "Proyección Ofensiva", desc: "Pique por la banda y centro preciso.", power: 12, cost: 2, acc: 90, dmg: "pase", tags: ["carrilero"] },
  { id: "sk_marca_personal", name: "Marca Personal", desc: "Sigue al rival como sombra.", power: 14, cost: 2, acc: 95, dmg: "defensa", tags: ["defensa"], cd: 2 },
  { id: "sk_liderazgo", name: "Liderazgo", desc: "Arenga al equipo.", power: 0, cost: 3, acc: 100, dmg: "fisico", tags: ["capitán"], cd: 4 },
  { id: "sk_tiro_libre", name: "Tiro Libre", desc: "Disparo con efecto sobre la barrera.", power: 24, cost: 3, acc: 75, dmg: "tiro", tags: ["tiro"], cd: 3 },
  { id: "sk_quite", name: "Quite Limpio", desc: "Barrida precisa que recupera.", power: 12, cost: 1, acc: 92, dmg: "defensa", tags: ["defensa"] },
  { id: "sk_pared", name: "Pared", desc: "Pase y devolución rápida.", power: 15, cost: 2, acc: 93, dmg: "pase", tags: ["pase"] },
  { id: "sk_media_vuelta", name: "Media Vuelta", desc: "Giro y remate fulminante.", power: 22, cost: 2, acc: 85, dmg: "tiro", tags: ["tiro"], cd: 1 },
  { id: "sk_rabona", name: "Rabona", desc: "Centro o tiro cruzando piernas.", power: 19, cost: 2, acc: 75, dmg: "regate", tags: ["lujo"], cd: 2 },
  { id: "sk_tackleo", name: "Tackleo Firme", desc: "Entrada fuerte que frena al rival.", power: 14, cost: 1, acc: 92, dmg: "fisico", tags: ["fisico"] },
  { id: "sk_zurdazo", name: "Zurdazo al Ángulo", desc: "Disparo colocado al segundo palo.", power: 24, cost: 3, acc: 82, dmg: "tiro", tags: ["tiro"], cd: 2 },
  { id: "sk_diagonal", name: "Diagonal Letal", desc: "Pase largo diagonal que parte la defensa.", power: 14, cost: 2, acc: 90, dmg: "pase", tags: ["pase"], cd: 1 },
  { id: "sk_penales", name: "Especialista en Penales", desc: "Lee al pateador y adivina el palo.", power: 24, cost: 4, acc: 70, dmg: "reflejos", tags: ["arco"], cd: 5 },
  { id: "sk_regate_doble", name: "Regate Doble", desc: "Dos amagos consecutivos.", power: 16, cost: 2, acc: 88, dmg: "regate", tags: ["regate"], cd: 1 },
  { id: "sk_volea", name: "Volea", desc: "Remate de volea cruzada.", power: 26, cost: 3, acc: 72, dmg: "tiro", tags: ["tiro"], cd: 2 },
];
